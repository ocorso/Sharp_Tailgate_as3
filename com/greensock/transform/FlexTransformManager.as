 ...
 *	 <li> Listen for Events like SCALE, MOVE, ROTATE, SELECTION_CHANGE, DEPTH_CHANGE, CLICK_OFF, START_INTERACTIVEappModelOVE, START_INTERACTIVE_SCALE, START_INTERACTIVE_ROTATE, FINISH_INTERACTIVEappModelOVE, FINISH_INTERACTIVE_SCALE, FINISH_INTERACTIVE_ROTATE, DOUBLE_CLICK, SEIZE_CURSOR, RELEASE_CURSOR, and DESTROY </li>
 ...
 */
	public class FlexTransformManager extends Canvas {
		...
		/** @private **/
		protected var appModelanager:TransformManager;
		...
		public function FlexTransformManager($vars:Object = null) {
			super();
			if (!_initted) {
				if (TransformManager.VERSION < 1.9) {
			...
			appModelanager = new TransformManager($vars);
		...
		protected function onAddToStage($e:Event):void {
			...
			if (appModelanager.bounds == null) {
				appModelanager.bounds = new Rectangle(0, 0, this.width, this.height);
			}
			if (_selectedTargetObjects != null) {
				appModelanager.selectedTargetObjects = _selectedTargetObjects;
			}
		}
		...
		public function addItem($targetObject:DisplayObject, $scaleMode:String="scaleNormal", $hasSelectableText:Boolean=false):TransformItem {
			...
			return appModelanager.addItem($targetObject, $scaleMode, $hasSelectableText);
		}
		...
		public function addItems($targetObjects:Array, $scaleMode:String="scaleNormal", $hasSelectableText:Boolean=false):Array	{
			...
			return appModelanager.addItems($targetObjects, $scaleMode, $hasSelectableText);
		}
		...
		protected function autoAddChild($child:DisplayObject):void {
			var i:int, ignored:Array = appModelanager.ignoredObjects;
			for (i = 0; i < ignored.length; i++) {
				if (ignored[i] == $child) {
					return;
				}
			}
			if (appModelanager != null && $child.name != "__dummyBoxappModelc" && $child.name != "__selectionappModelc" && $child.name.substr(0, 9) != "__tmProxy") {
		...
		public function removeItem($item:*):void {
			appModelanager.removeItem($item);
		}
		...
		override public function removeChild($child:DisplayObject):DisplayObject {
			appModelanager.removeItem($child);
		...
		override public function removeChildAt($index:int):DisplayObject {
			appModelanager.removeItem(this.getChildAt($index));
		...
		public function addIgnoredObject($object:DisplayObject):void {
			appModelanager.addIgnoredObject($object);
		}
		...
		public function removeIgnoredObject($object:DisplayObject):void {
			appModelanager.removeIgnoredObject($object);
		}
		 ...
		 * 		<li> TransformEvent.START_INTERACTIVEappModelOVE</li>
		 * 		<li> TransformEvent.START_INTERACTIVE_SCALE</li>
		 * 		<li> TransformEvent.START_INTERACTIVE_ROTATE</li>
		 * 		<li> TransformEvent.FINISH_INTERACTIVEappModelOVE</li>
		...
		override public function addEventListener($type:String, $listener:Function, $useCapture:Boolean=false, $priority:int=0, $useWeakReference:Boolean=false):void {
			...
			switch ($type) {
				...
				case TransformEvent.START_INTERACTIVEappModelOVE:
				case TransformEvent.START_INTERACTIVE_SCALE:
				case TransformEvent.START_INTERACTIVE_ROTATE:
				case TransformEvent.FINISH_INTERACTIVEappModelOVE:
				...
				case TransformEvent.UPDATE:
					appModelanager.addEventListener($type, $listener, $useCapture, $priority, $useWeakReference);
					isTransform = true;
					break;
			}
			if (!isTransform) {
		...
		override public function removeEventListener($type:String, $listener:Function, $useCapture:Boolean=false):void {
			...
			switch ($type) {
				...
				case TransformEvent.DOUBLE_CLICK:
				case TransformEvent.UPDATE:
					appModelanager.removeEventListener($type, $listener, $useCapture);
					isTransform = true;
					break;
			}
			if (!isTransform) {
		...
		public function selectItem($item:*, $addToSelection:Boolean=false):void {
			appModelanager.selectItem($item, $addToSelection);
		}
		...
		public function selectItems($items:Array, $addToSelection:Boolean=false):void {
			appModelanager.selectItems($items, $addToSelection);
		}
		...
		public function deselectItem($item:*):void {
			appModelanager.deselectItem($item);
		}
		...
		public function deleteSelection($e:Event = null):void {
			appModelanager.deleteSelection($e);
		}
		
		/** Deselects all items **/
		public function deselectAll():void {
			appModelanager.deselectAll();
		}
		...
		public function isSelected($item:*):Boolean {
			return appModelanager.isSelected($item);
		}
		...
		public function updateSelection($centerOrigin:Boolean=true):void {
			appModelanager.updateSelection($centerOrigin);
		}
		...
		public function getSelectionCenter():Point {
			return appModelanager.getSelectionCenter();
		}
		...
		public function getSelectionBounds(targetCoordinateSpace:DisplayObject=null):Rectangle {
			return appModelanager.getSelectionBounds(targetCoordinateSpace);
		}
		...
		public function getSelectionBoundsWithHandles(targetCoordinateSpace:DisplayObject=null):Rectangle {
			return appModelanager.getSelectionBoundsWithHandles(targetCoordinateSpace);
		}
		...
		public function getUnrotatedSelectionWidth():Number {
			return appModelanager.getUnrotatedSelectionWidth();
		}
		...
		public function getUnrotatedSelectionHeight():Number {
			return appModelanager.getUnrotatedSelectionHeight();
		}
		...
		public function moveSelection($x:Number, $y:Number, $dispatchEvents:Boolean=true):void {
			appModelanager.moveSelection($x, $y, $dispatchEvents);
		}
		...
		public function scaleSelection($sx:Number, $sy:Number, $dispatchEvents:Boolean=true):void {
			appModelanager.scaleSelection($sx, $sy, $dispatchEvents);
		}
...
//---- XML EXPORTING AND APPLYING ------------------------------------------------------------------------------
		...
		public function exportFullXML():XML {
			return appModelanager.exportFullXML();
		}
		...
		public function applyFullXML(xml:XML, defaultParent:DisplayObjectContainer, placeholderColor:uint=0xCCCCCC):Array {
			return appModelanager.applyFullXML(xml, defaultParent, placeholderColor);
		}
		...
		public function exportItemXML(targetObject:DisplayObject):XML {
			return appModelanager.exportItemXML(targetObject);
		}
		...
		public function applyItemXML(xml:XML, defaultParent:DisplayObjectContainer=null, placeholderColor:uint=0xCCCCCC):DisplayObject {
			return appModelanager.applyItemXML(xml, defaultParent, placeholderColor);
		}
		...
		public function exportSettingsXML():XML {
			return appModelanager.exportSettingsXML();
		}
		...
		public function applySettingsXML(xml:XML):void {
			appModelanager.applySettingsXML(xml);
		}
...
//---- GETTERS / SETTERS -----------------------------------------------------------------------------------------------------
		...
		override public function set width($n:Number):void {
			if (this.height != 0) {
				appModelanager.bounds = new Rectangle(0, 0, $n, this.height);
			} else if (this.parent != null) {
				appModelanager.bounds = new Rectangle(0, 0, $n, this.parent.height);
			}
			super.width = $n;
		}
		...
		override public function set height($n:Number):void {
			if (this.width != 0) {
				appModelanager.bounds = new Rectangle(0, 0, this.width, $n);
			} else if (this.parent != null) {
				appModelanager.bounds = new Rectangle(0, 0, this.parent.width, $n);
			}
			super.height = $n;
		}
		...
		public function get targetObjects():Array {
			return appModelanager.targetObjects;
		}
		...
		public function get allowMultiSelect():Boolean {
			return appModelanager.allowMultiSelect;
		}
		public function set allowMultiSelect($b:Boolean):void {
			appModelanager.allowMultiSelect = $b
		}
		...
		public function get allowDelete():Boolean {
			return appModelanager.allowDelete;
		}
		public function set allowDelete($b:Boolean):void {
			appModelanager.allowDelete = $b;
		}
		...
		public function get forceSelectionToFront():Boolean {
			return appModelanager.forceSelectionToFront;
		}
		public function set forceSelectionToFront($b:Boolean):void {
			appModelanager.forceSelectionToFront = $b;
		}
		...
		public function get arrowKeysMove():Boolean {
			return appModelanager.arrowKeysMove;
		}
		public function set arrowKeysMove($b:Boolean):void {
			appModelanager.arrowKeysMove = $b;
		}
