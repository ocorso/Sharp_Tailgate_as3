 ...
 * @example Example AS3 code:<listing version="3.0">
 ...
 function initHandler(event:LoaderEvent):void {
	 ...
	 //get a MovieClip named "phoneAnimationappModelc" that's on the root of the subloaded swf
	 var mc:DisplayObject = loader.getSWFChild("phoneAnimationappModelc");
 ...
 */	
	public class SWFLoader extends DisplayObjectLoader {
		 ...
		 * you could put a MovieClip with an instance name of "phoneAnimationappModelc" on the stage (along with
		 * any other objects of course) and then when you load that swf you could use 
		 * <code>loader.getSWFChild("phoneAnimationappModelc")</code> to get that MovieClip. It would be 
		 * similar to doing <code>(loader.rawContent as DisplayObjectContainer).getChildByName("phoneAnimationappModelc")</code>
