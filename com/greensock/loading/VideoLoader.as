 ...
 */	
	public class VideoLoader extends LoaderItem {
		...
		protected function _refreshNetStream():void {
			...
			_ns.client = {onMetaData:appModeletaDataHandler, onCuePoint:_cuePointHandler};
...
//---- EVENT HANDLERS ------------------------------------------------------------------------------------
		...
		/** @private **/
		protected function appModeletaDataHandler(info:Object):void {
